...
namespace VidU.data
{
    public class NumberDictionaryXml : XmlBase
    {
        public NumberDictionaryXml() { }
        public NumberDictionaryXml(XElement xElement) : base(xElement) { }
        ...
        {
            ThisElement = new XElement(nameof(NumberDictionaryXml),
        ...
        {
            ThisElement = xElement.Element(nameof(NumberDictionaryXml));
